...
// vgl. mit Abbildung 4.13 im Aldat-Skript
// Anmerkung: Entgegen der Behauptung im Skript müssen hier
//            *drei* Zeiger (nicht zwei Zeiger) umgehangen werden.
void bt_rotate_right(BinTreeNode** link) {
    BinTreeNode* v = *link; // Benennung wie in der Abbildung
    BinTreeNode* w = v->left;
...
// vgl. mit Abbildung 4.14 im Aldat-Skript
// Anmerkung: Entgegen der Behauptung im Skript müssen hier
//            *drei* Zeiger (nicht zwei Zeiger) umgehangen werden.
void bt_rotate_left(BinTreeNode** link) {
    BinTreeNode* v = *link; // Benennung wie in der Abbildung
    BinTreeNode* w = v->right;
